...
function SubtractQtyByID(props) {
    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <br />
                <label htmlFor="amount">Subtract Quantity</label>
                <input id="amount" type="text" onChange={handleFieldChange} />
                <br />
